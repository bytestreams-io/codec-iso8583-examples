...
class CMFMessageTest {
  ...
  void decodePanFromJposPackedMessage() throws Exception {
    ...
    assertThat(CMFMessage.MESSAGE_AUTHENTICATION_CODE.get(decoded))
        .isEqualTo(new byte[] {0x01, 0x02, 0x03, 0x04});
    ...
    assertThat(CMFMessage.BATCH_FILE_TRANSFER_CONTROL_DATA.get(decoded))
    ...
    assertThat(CMFMessage.RECONCILIATION_DATA_SECONDARY.get(decoded))
        .isEqualTo(
            "123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890");
    ...
    assertThat(CMFMessage.TRANSACTION_DESTINATION_INSTITUTION_ID_CODE.get(decoded))
        .isEqualTo("12345678901");
    ...
    assertThat(CMFMessage.ACCOUNT_IDENTIFICATION_1.get(decoded))
    ...
    assertThat(CMFMessage.RECONCILIATION_FEE_AMOUNTS_CREDIT.get(decoded))
    ...
    assertThat(reparsed.getString(75))
        .isEqualTo(
            "123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890");
