...
public class VerificationCapability {
  ...
  static final Codec<VerificationCapability> CODEC =
      FieldCodecs.singleBlockBitmap(4).xmap(VerificationCapability::new, vc -> vc.bitmap);

  private final SingleBlockBitmap bitmap;

  private VerificationCapability(SingleBlockBitmap bitmap) {
    this.bitmap = bitmap;
  }
